...
class SlideWindow:
    ...
    def slidewindow(self, img):
        ...
        # draw line
        # 130 -> 150 -> 180
        pts_left = np.array([[width / 2 - 70, height], [width / 2 - 70, height - 60], [width / 2 - 170, height - 80],
                             [width / 2 - 170, height]], np.int32)
        ...
        # 337 -> 310
        good_left_inds = \
        ((nonzerox >= width / 2 - 170) & (nonzeroy >= nonzerox * 0.33 + 300) & (nonzerox <= width / 2 - 90)).nonzero()[
            0]
        good_right_inds = ((nonzerox >= width / 2 + 20) & (nonzeroy >= nonzerox * (-0.48) + 500) & (
